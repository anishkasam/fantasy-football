...
yearlydata = pd.read_csv("2017data/2017yearly.csv")
defenses = pd.read_csv("2017data/2017defenses.csv")
schedules = pd.read_csv("2017data/2017schedule.csv")
...
for i in range(1, 17):
  weeklydata = pd.read_csv("2017data/2017weekly/week" + str(i) + ".csv")
