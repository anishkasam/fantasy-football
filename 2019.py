...
yearlydata = pd.read_csv("2019data/2019yearly.csv")
defenses = pd.read_csv("2019data/2019defenses.csv")
schedules = pd.read_csv("2019data/2019schedule.csv")
...
for i in range(1, 17):
  weeklydata = pd.read_csv("2019data/2019weekly/week" + str(i) + ".csv")
...
schedules = schedules.drop(["W17"], axis = 1)
...
def correlation(player):
  try: 
    ...
    for i in range(1, 17):
      ...
      if (opponent == "BYE" or opponent == "OAK" or points == "NaN"):
        continue
