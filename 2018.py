...
yearlydata = pd.read_csv("2018data/2018yearly.csv")
defenses = pd.read_csv("2018data/2018defenses.csv")
schedules = pd.read_csv("2018data/2018schedule.csv")
...
for i in range(1, 17):
  weeklydata = pd.read_csv("2018data/2018weekly/week" + str(i) + ".csv")
